...
!(function(t) {
    ...
    return (function t(e, s, i) {
        ...
        for (
            var n = "function" == typeof require && require, r = 0; r < i.length; r++
        )
            a(i[r]);
        return a;
    })({
                                ...
                                if ("txt" === l.type || "csv" === l.type) {
                                    for (o = "", n = 0; n < s.length; n++) {
                                        for (r = 0; r < s[n].cells.length; r++)
                                            if (!l.skipColumn.includes(e[r].originalCellIndex) &&
                                    ...
                                    for (
                                        o = `INSERT INTO \`${l.tableName}\` (`, n = 0; n < e.length; n++
                                    )
